...
function registerTracingMetrics (counters) {
  const names = [
    ...
    'Peer-_requestRangeBlock_add-block-to-replicator',
    'Peer-_requestRangeBlock_make-request',
    'Peer-_requestRangeBlock_insta-insta-gc',
    'Peer-_requestRangeBlock_adding-inflight',
    'Peer-send',
    'Peer-ondata'
  ]
