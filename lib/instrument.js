...
module.exports = async function instrument (tracker, logger, {
  repl, instrumentPort, instrumentHost, detailedMetrics, seedListKey, trace, getDescriptionWaitMs
}) {
...
function setupTracing (logger) {
  ...
  Hypertrace.setTraceFunction(({ id, object, caller }) => {
    if (object.className !== 'Peer' && object.className !== 'Channel') return
